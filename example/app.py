...
def character_serializer(obj):
    return {"id": obj.id, "name": obj.name, "created_at": obj.created_at.isoformat()}
...
class CharacterObjectEndpoint(
    Endpoint, GetObjectMixin, PutObjectMixin, DeleteObjectMixin
):
    ...
    def get_object(self):
        ...
        if not obj:
            payload = {"message": "Character object not found."}
